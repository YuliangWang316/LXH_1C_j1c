...
filnal_scaler_AN_L_1C4_L_1C_KO4<-filnal_scaler_AN_L_1C4[which(filnal_scaler_AN_L_1C4$sample == "L_1C_KO4"),]
filnal_scaler_AN_L_1C4_L_1C_WT4<-filnal_scaler_AN_L_1C4[which(filnal_scaler_AN_L_1C4$sample == "L_1C_WT4"),]
filnal_scaler_AN_L_1C4_L_1C_KO4$mean_signal<-filnal_scaler_AN_L_1C4_L_1C_KO4$mean_signal +0.63
filnal_scaler_AN_L_1C4_new<-rbind(filnal_scaler_AN_L_1C4_L_1C_KO4,filnal_scaler_AN_L_1C4_L_1C_WT4)
filnal_scaler_AN_L_1C4_new$sample<-factor(filnal_scaler_AN_L_1C4_new$sample,levels = c("L_1C_KO4","L_1C_WT4"))
...
filnal_scaler_JB_L_1C_J1C_KO4$mean_signal<-filnal_scaler_JB_L_1C_J1C_KO4$mean_signal +0.60
